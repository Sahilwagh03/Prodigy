...
const AboutUs = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      animateAboutUs(sectionRef.current!);
    }, sectionRef);
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col gap-4 lg:flex-row px-4 max-w-340 mx-auto">
        <div className="about-image flex-4 order-1 lg:order-2 p-4 bg-neutral-200 rounded-3xl overflow-hidden flex items-center justify-center">
          <Image
        ...
        <div className="lg:h-screen flex-6 order-2 lg:order-1">
          <div className="max-w-125 h-full flex flex-col gap-5 lg:gap-10 justify-center">
            <h3 className="about-heading text-[2rem] lg:text-[2.5rem] font-semibold leading-tight tracking-[-.075rem]">
              Innovative ideas and bold execution that drive measurable growth
            </h3>

            <div className="flex flex-col gap-4 justify-end">
              <p className="about-heading text-[1rem] lg:text-[1.25rem] font-semibold tracking-[-.0375rem] leading-normal">
